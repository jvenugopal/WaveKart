...
/**
* Specifies methods used to obtain and modify Productorder related information
* which is stored in the database.
*/
@Repository("eshopping.ProductorderDao")
public class ProductorderDao extends WMGenericDaoImpl <Productorder, Integer> {
